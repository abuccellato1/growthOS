...
export async function POST(request: Request) {
  ...
  const coverTitle = h1Block && h1Block.type === 'h1' ? h1Block.text : 'ICP Blueprint'
      ...
      <Page size="A4" style={styles.coverPage}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          ...
          <View style={styles.coverBadge}>
            <Text style={styles.coverBadgeText}>Generated by GrowthOS · Powered by Alex</Text>
          </View>
        </View>
      </Page>
  ...
  return new Response(buffer, {
    headers: {
      ...
      'Content-Disposition': 'attachment; filename="ICP-Blueprint.pdf"',
    },
  })
}
